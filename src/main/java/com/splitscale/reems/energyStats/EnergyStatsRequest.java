...
public class EnergyStatsRequest {
    private String id;
    ...
    public EnergyStatsRequest() {
        // default
    }

    public EnergyStatsRequest(String id, Date created, Date edited, String totalConsumption, String changeThisMonth,
