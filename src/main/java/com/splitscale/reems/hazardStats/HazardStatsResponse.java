package com.splitscale.reems.hazardStats;

import java.sql.Date;

public class HazardStatsResponse {
    private String id;
    ...
    public HazardStatsResponse() {
        // default
    }

    public HazardStatsResponse(String id, Date created, Date edited, long total_hazards, long change_this_month) {
        this.id = id;
